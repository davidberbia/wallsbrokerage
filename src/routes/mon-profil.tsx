...
function MyProfilePage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      const payload = { ...investorPayload({ ...draft, job_title: finalJob, asset_classes: selectedAssets, strategies: allStrategies }), user_id: user.id };
